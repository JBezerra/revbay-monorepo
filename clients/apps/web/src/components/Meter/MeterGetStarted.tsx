  ...
  return (
    <div className="dark:bg-polar-800 dark:border-polar-700 flex flex-col gap-y-4 rounded-2xl border border-gray-200 bg-gray-100 p-6">
      <div className="flex flex-col gap-y-2">
        <h2 className="text-xl">Comece a usar a métrica</h2>
        <p className="dark:text-polar-500 text-gray-500">
          Envie eventos que correspondem ao Filtro da Métrica, para a
          nossa API, para que possamos calcular o uso da métrica.
        </p>
      </div>
