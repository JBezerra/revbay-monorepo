...
export default function ConfirmationButton({
  ...
  const getConfirmationStyles = () => {
    if (destructive) {
      return {
        container: 'border-red-200 bg-red-50 dark:border-red-800/40 dark:bg-red-950/30',
    ...
    return {
      container: 'border-blue-200 bg-blue-50 dark:border-blue-800/40 dark:bg-blue-950/30',
